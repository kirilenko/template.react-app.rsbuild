...
import { getAbsolutePath } from '@/shared/router'
  ...
  <>
    ...
    <FadeContainer id="about-intention">
      <div className="absolute left-0 top-0 flex min-h-full w-full gap-4 overflow-y-auto bg-stone-800">
        <NavLink
          className="w-8 flex-none text-4xl"
          to={getAbsolutePath({ path: 'root.about', paths })}
        >
          ←
        </NavLink>
...
export default withRenderLog(Intention)
